...
{/* <div class="mt-[1px] py-6  w-full rounded-md p-[20px] shadow-lg bg-white sm:py-12 mb-[200px]">
<div class="question-container mt-[10px]">
  <div class="question flex align-center gap-[1px]">
    <h3 class="number mt-[4px]">1.</h3>
    ...
    <div class="wrapper flex gap-[10px] align-center">
      ...
      <div class="detail-wrapper flex  gap-[30px]">
        ...
        <div class="wrapper-set-true flex flex-col ml-[30px]">
          ...
          <input type="radio" name="radio-4" class="true-answer radio radio-accent mt-[22px]" value=""/>
          <input type="radio" name="radio-4" class="true-answer radio radio-accent mt-[23px]" value=""/>
          <input type="radio" name="radio-4" class="true-answer radio radio-accent mt-[24px]" value=""/>
        </div>
      </div>
    </div>
